...
class User_Management extends MY_Controller {
	...
	public function authenticate() {
		...
		if ($username == "facility") {
			$session_data = array('full_name' => "Facility Representative",'user_id'=>1,'user_indicator'=>"facility");
		} else if ($username == "moh") {
			$session_data = array('full_name' => "MOH Official",'user_id'=>1,'user_indicator'=>"moh");
		}
		$this -> session -> set_userdata($session_data);
		redirect("home_controller");
